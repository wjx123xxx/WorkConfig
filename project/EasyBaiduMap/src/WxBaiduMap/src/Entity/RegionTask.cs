...
namespace Wx.Common.BaiduMap.Entity
{
    ...
    public class RegionTask : IMapTask
    {
        ...
        /// 任务组列表
        /// </summary>
        private readonly List<ZoomTask> m_zoomTasks = new List<ZoomTask>();
        ...
        /// 构造函数
        /// </summary>
        public RegionTask(IEnumerable<MercatorPoint> points, int minZoom, int maxZoom)
        {
        ...
        public IEnumerator<ZoomTask> GetEnumerator()
        {
