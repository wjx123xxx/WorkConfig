...
namespace Wx.Lib.WlyAutoBiz.WlyTasks.TimeTask
{
    ...
    /// 活动副本刷箱子
    /// </summary>
    [WlyTask(WlyTaskType.活动副本)]
    public class 任务_活动副本 : WlyTimeTask
    {
        #region Constructors
        ...
        /// 构造函数
        /// </summary>
        public 任务_活动副本(string id, TimeSpan startTime, TimeSpan endTime) : base(id, startTime, endTime)
        {
        }
        ...
        {
            return entity.AccountInfo.GetSwitchInfo(WlySwitchType.活动副本).Enable;
        }
        ...
        {
            if (!entity.AccountInfo.GetSwitchInfo(WlySwitchType.活动副本).Enable)
            {
                return new WlyTaskInfo(ID, true);
            }

            var dmGuid = entity.DMGuid;
            WlyViewMgr.GoTo(dmGuid, WlyViewType.场景_活动副本);
            ...
            {
                Attack(dmGuid, new WxPoint(720, 153));
            }
